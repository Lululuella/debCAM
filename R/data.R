...
#' Proportions used in experiments and pure expression profiles are also provided.
#' @docType data
#' @name ratMix3
#' @usage data(ratMix3)
#' @format A list with three matrices: mixture profiles (X), mixing proportions (A) and pure profiles (S).
#' @references Shen-Orr et al. (2010) Nat Methods 2010 Apr;7(4):287-9. PMID: 20208531
NULL
